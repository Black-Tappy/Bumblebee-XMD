...
zokou({ nomCom: "tagall2", categorie: 'Group', reaction: "📣" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "promote2", categorie: 'Group', reaction: "⭐" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "demote2", categorie: 'Group', reaction: "👺" }, async (dest, zk, commandeOptions) => {
  let { repondre, msgRepondu, infosGroupe, auteurMsgRepondu, verifGroupe, auteurMessage, superUser, idBot } = commandeOptions;
  let membresGroupe = verifGroupe ? await infosGroupe.participants : ""
  if (!verifGroupe) { return repondre("For groups only"); }
...
/** ***func remove****  **/
/** **retirer** */
zokou({ nomCom: "remove2", categorie: 'Group', reaction: "👺" }, async (dest, zk, commandeOptions) => {
          ...
          if (membre) {
            if (admin == false) {
              ...
              var sticker = new Sticker(gifLink, {
                pack: 'Ᏼᴜᴍʙʟᴇʙᴇᴇ-ХᴍᎠ', // The pack name
...
zokou({ nomCom: "del2", categorie: 'Group',reaction:"🧹" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 zokou({ nomCom: "antilink2", categorie: 'Group', reaction: "🔗" }, async (dest, zk, commandeOptions) => {
 ...
 zokou({ nomCom: "antibot2", categorie: 'Group', reaction: "😬" }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "gdesc2", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
zokou({ nomCom: "gpp2", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
...
/////////////
zokou({nomCom:"tag2",categorie:'Group',reaction:"🎤"},async(dest,zk,commandeOptions)=>{
