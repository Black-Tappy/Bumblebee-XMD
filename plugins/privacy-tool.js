...
┃◈┃• 🏷️setppall - Set profile pic privacy
┃◈┃• 🟢setonline - Set online privacy
┃◈┃• 🤵‍♂️setpp - Change bot's profile pic
┃◈┃• 👑setmyname - Change bot's name
┃◈┃• ♻️updatebio - Change bot's bio
...
*Note:* Most commands are owner-only`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://files.catbox.moe/o3ojhw.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
