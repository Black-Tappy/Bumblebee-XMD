...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Black-Tappy/Bumblebee-XMD';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/o3ojhw.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'Ᏼᴜᴍʙʟᴇʙᴇᴇ-ХᴍᎠ',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
