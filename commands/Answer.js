...
zokou({nomCom:"bee",reaction:"📡",categorie:"AI"},async(dest,zk,commandeOptions)=>{
...
.catch(error => {
  ...
  zokou({ nomCom: "dalle", reaction: "📡", categorie: "AI" }, async (dest, zk, commandeOptions) => {
    ...
    try {
      ...
      let caption = '*powered by ʙᴜᴍʙʟᴇʙᴇᴇ-xᴍᴅ*';
...
zokou({ nomCom: "bumble", reaction: "🤔", categorie: "AI" }, async (dest, zk, commandeOptions) => {
    const { repondre, arg, ms } = commandeOptions;
