...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Black-Tappy/Bumblebee-XMD',
    OWNER_NAME : process.env.OWNER_NAME || "Ⴊl𐌀Ꮳk 𐌕𐌀ႲႲჄ",
    ...
    URL: process.env.URL || "https://files.catbox.moe/2w7amm.jpg",  
   ...
   GREET_MSG: process.env.GREET_MSG || "Huskii am unavailable mzee 😂",               
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by Bee🐝',   
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || 'no',
    AUTOBIO: process.env.AUTOBIO || 'yes',       
    ANTICALL_MSG : process.env.ANTICALL_MSG || 'call declined',             
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029Vaan9TF9Bb62l8wpoD47",
    EVENTS :process.env.EVENTS || "yes",
    CAPTION : process.env.CAPTION || "Bumblebee-XMD",
    BOT : process.env.BOT_NAME || 'Bumblebee-XMD',
